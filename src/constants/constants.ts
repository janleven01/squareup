...
export const trustedBy = [
  { logoUrl: "icons/zapier-logo.svg", label: "zapier logo" },
  { logoUrl: "icons/spotify-logo.svg", label: "spotify logo" },
  { logoUrl: "icons/zoom-logo.svg", label: "zoom logo" },
  { logoUrl: "icons/slack-logo.svg", label: "slack logo" },
  { logoUrl: "icons/amazon-logo.svg", label: "amazon logo" },
  { logoUrl: "icons/adobe-logo.svg", label: "adobe logo" },
];

export const services = [
  {
    iconUrl: "/icons/design-icon.svg",
    label: "Design",
    description:
  ...
  {
    iconUrl: "/icons/engineering-icon.svg",
    label: "Engineering",
    description:
      "Our engineering team combines technical expertise with a passion for innovation to build robust and scalable digital solutions. We leverage the latest technologies and best practices to deliver high-performance applications tailored to your specific needs.",
  },
  {
    iconUrl: "/icons/project-icon.svg",
...
export const whyChooseUs = [
  {
    iconUrl: "/icons/expertise-icon.svg",
    label: "Expertise",
    description:
  ...
  {
    iconUrl: "/icons/client-centric-icon.svg",
  ...
  {
    iconUrl: "/icons/results-driven-icon.svg",
  ...
  {
    iconUrl: "/icons/collaborative-icon.svg",
