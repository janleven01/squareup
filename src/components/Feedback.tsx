    ...
    <div className="max-container">
      ...
      <ul className="grid-cols-1 bg-grey_10 md:grid md:grid-cols-2">
        {feedbacks.map((feedback, index) => (
          ...
          >
            <h3 className="text-xl font-medium text-green_80 xl:text-2xl">
              {feedback.title}
            </h3>
            ...
            <div className="mt-10 flex items-center justify-between gap-2 rounded-lg border-2 border-grey_15 p-3 xl:p-5">
              ...
              <Link
                href="/"
                className="hidden rounded-lg bg-grey_15 px-4 py-3 text-center text-sm font-medium text-grey_90 hover:bg-grey_12 hover:text-white lg:block xl:px-5 xl:py-4 xl:text-lg"
              >
                Open Website
              </Link>
              <Link
                href="/"
                className="hidden rounded-lg bg-grey_15 px-4 py-3 text-center text-sm font-medium hover:text-green_50 max-lg:block xl:px-5 xl:py-4 xl:text-lg"
              >
